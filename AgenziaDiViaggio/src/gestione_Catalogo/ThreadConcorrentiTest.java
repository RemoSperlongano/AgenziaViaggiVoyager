...
public class ThreadConcorrentiTest {
	...
	public static void main(String[] args) {
		...
		ProgettistaThread1 pt1 = new ProgettistaThread1(controlloreProgettista);
		ProgettistaThread2 pt2 = new ProgettistaThread2(controlloreProgettista);
		ProgettistaThread3 pt3 = new ProgettistaThread3(controlloreProgettista);
		ProgettistaThread4 pt4 = new ProgettistaThread4(controlloreProgettista);
		ProgettistaThread5 pt5 = new ProgettistaThread5(controlloreProgettista);
		
		PromotoreThread1 prt1 = new PromotoreThread1(controllorePromotore);
		PromotoreThread2 prt2 = new PromotoreThread2(controllorePromotore);
		PromotoreThread3 prt3 = new PromotoreThread3(controllorePromotore);
		PromotoreThread4 prt4 = new PromotoreThread4(controllorePromotore);
		PromotoreThread5 prt5 = new PromotoreThread5(controllorePromotore);
		...
		Thread t6 = new Thread(prt1);
		Thread t7 = new Thread(prt2);
		Thread t8 = new Thread(prt3);
		Thread t9 = new Thread(prt4);
		Thread t10 = new Thread(prt5);
