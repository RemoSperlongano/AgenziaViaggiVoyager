...
public class ControlloreGestioneCatalogo extends Controllore {
	...
	public void aggiungiViaggio(String ambiente, String mezzo, String tipoMezzo, String cittaPartenza, String cittaArrivo, String via, String info) throws TrattaException, ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, IDEsternoElementoException, CittaCoincidentiException, TipoMezzoException, DirittiException {	
		...
		//Nel caso in cui ho selezionato un tipoMezzo devo verificare se il mezzo specificato non sia gi� stato introdotto in catalogo
		if (!tipoMezzo.equals("")){
			...
			//Nel caso in cui non ho selezionato un tipo di mezzo, devo verificare se il mezzo non sia gi� stato specificato in catalogo
		...
		//questo ciclo for mi serve per controllare se il mezzo passato da parametro ha gi� il tipo inserito (quindi se c'� uno spazio in mezzo)
