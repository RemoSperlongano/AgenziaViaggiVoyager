...
public class DialogModificaUtente extends JDialog{
	...
	private void buildDialog() {
		...
		this.textfieldNome = new JTextField(this.utenteBean.getNome(), 20);
		this.textfieldCognome = new JTextField(this.utenteBean.getCognome(), 20);
		this.textfieldCitta = new JTextField(this.utenteBean.getCitta(), 20);
		...
		this.textfieldMail = new JTextField(this.utenteBean.getMail(), 20);
		this.comboRuolo = new JComboBox<String>(RUOLI);	
		this.comboRuolo.setSelectedIndex(this.utenteBean.getRuolo().getId());
		this.textfieldUsername = new JTextField(this.utenteBean.getUsername(), 20);
		this.passwordfieldPassword = new JPasswordField(this.utenteBean.getPassword(), 20);
