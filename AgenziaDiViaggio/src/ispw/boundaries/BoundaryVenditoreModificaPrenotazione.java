 ...
 */
public class BoundaryVenditoreModificaPrenotazione extends JFrame {
	/**
	 * 
	 */
	...
	private BoundaryVenditoreModificaPrenotazione boundaryVenditoreModificaPrenotazione;
	public static JPanel pannelloVenditoreModificaPrenotazione;
	...
	public BoundaryVenditoreModificaPrenotazione() throws DAOException,
		...
		pannelloVenditoreModificaPrenotazione.setSize(AABoundaryAvvio.Frame.getWidth(),
			...
			if (event.getSource() == aggiuntaBiglietti) {
				...
				try {
					if (!controlloreVenditore.verificaPrenotazione(prenotazione
						...
						pannelloVenditoreModificaPrenotazione.setVisible(false);
						new BoundaryVenditoreAggiuntaBiglietti(boundaryVenditoreModificaPrenotazione);
					}
				...
				if (!controlloreVenditore.verificaPrenotazione(prenotazione
					...
					pannelloVenditoreModificaPrenotazione.setVisible(false);
					try {
						new BoundaryVenditoreRimuoviBiglietti(boundaryVenditoreModificaPrenotazione);
