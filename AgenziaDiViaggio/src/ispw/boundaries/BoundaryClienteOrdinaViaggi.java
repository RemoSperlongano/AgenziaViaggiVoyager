...
public class BoundaryClienteOrdinaViaggi extends JFrame {
	...
	public static JPanel pannelloGestoreOrdinaViaggi;
	...
	public BoundaryClienteOrdinaViaggi() throws DAOException, MapException,
		...
		pannelloGestoreOrdinaViaggi = new JPanel();

		/* Impostazioni pannelloSelezionaViaggioOfferta */
		pannelloGestoreOrdinaViaggi.setSize(AABoundaryAvvio.Frame.getWidth(),
				AABoundaryAvvio.Frame.getHeight());
		AABoundaryAvvio.Frame.add(pannelloGestoreOrdinaViaggi);
		pannelloGestoreOrdinaViaggi.setLayout(null);
		...
		pannelloGestoreOrdinaViaggi.add(panelTitolo);
		pannelloGestoreOrdinaViaggi.add(panelComboBox);
		...
		public void actionPerformed(ActionEvent e) {
			...
			// Se la comboBox interessata è quella delle città di arrivo
				...
				if (!cittaArrivo.equals("--")) {
					...
					try {
						selectedList = controlloreCliente.estrazioneVia(
	...
	private void addComboBox(JComboBox<String> comboBox) {
		...
		try {
			selectedList = controlloreCliente.estrazioneAmbienti();
